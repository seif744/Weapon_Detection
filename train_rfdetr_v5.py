"""
train_rfdetr_v4.py -- RF-DETR Large, regularized.
...
model.train(
    ...
    # PATHS
    # ---------------------------------------------------------------
    dataset_dir='datasets_neg_coco',
    output_dir='runs_rfdetr/rfdetr_l_v5',
    ...
    epochs=45,
    early_stopping=True,
    early_stopping_patience=7,     # 7 evals x eval_interval 3 = 21 epochs
